  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 text-gray-300">
      ...
      <div className="space-y-8 glass p-8 rounded-3xl">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">8. Content Moderation and Enforcement</h2>
          <p className="leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">11. Account Termination and Deletion</h2>
          <p className="leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">12. Data Export</h2>
          <p className="leading-relaxed">

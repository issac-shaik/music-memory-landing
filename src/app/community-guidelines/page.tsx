  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 text-gray-300">
      ...
      <div className="space-y-8 glass p-8 rounded-3xl">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">2. Community Principles</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">3. Content Standards</h2>
          <p className="leading-relaxed mb-4">
            All publicly shared content must comply with the following standards:
          </p>

          <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.1 Permitted Content</h3>
          <ul className="list-disc pl-5 space-y-2 text-gray-400">
          ...
          <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.2 Prohibited Content</h3>
          <p className="leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">4. Interaction Standards</h2>

          <h3 className="text-lg font-semibold text-white mt-6 mb-3">4.1 Comments and Replies</h3>
          <ul className="list-disc pl-5 space-y-2 text-gray-400">
          ...
          <h3 className="text-lg font-semibold text-white mt-6 mb-3">4.3 Usernames and Profiles</h3>
          <ul className="list-disc pl-5 space-y-2 text-gray-400">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">5. Reporting and Moderation</h2>

          <h3 className="text-lg font-semibold text-white mt-6 mb-3">5.1 Reporting Violations</h3>
          <p className="leading-relaxed mb-4">
            If you encounter content that violates these Guidelines, you may report it using the flag icon on any public entry. When submitting a report, you will be asked to select a reason from the following categories:
          </p>
          <ul className="list-disc pl-5 space-y-2 text-gray-400">
          ...
          <p className="leading-relaxed mt-4">
            Each user may submit one (1) report per entry. False or malicious reporting is itself a violation of these Guidelines and may result in enforcement action against the reporter.
          </p>

          <h3 className="text-lg font-semibold text-white mt-6 mb-3">5.2 Moderation Process</h3>
          <p className="leading-relaxed mb-4">
            Our moderation system operates as follows:
          </p>
          <ul className="list-disc pl-5 space-y-2 text-gray-400">
          ...
          <h3 className="text-lg font-semibold text-white mt-6 mb-3">5.3 Profanity Filter</h3>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">6. Visibility and Access</h2>
          <ul className="list-disc pl-5 space-y-2 text-gray-400">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">7. Notifications</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">9. Consequences of Violations</h2>
          <p className="leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">10. Appeals</h2>
          <p className="leading-relaxed">
            If you believe that enforcement action was taken against your account or content in error, you may contact us at <a href="mailto:issac.shaik@hotmail.com" className="text-blue-400 hover:underline">issac.shaik@hotmail.com</a> to request a review. Please include your username, a description of the content or action in question, and the reason you believe the action was taken in error. We will review appeals in good faith but are not obligated to reverse any enforcement decision.
          </p>
        </section>

...
export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-24" style={{ color: 'var(--ink-90)' }}>
      <h1 className="text-4xl md:text-5xl font-extrabold mb-8" style={{ color: 'var(--ink)' }}>Privacy Policy</h1>
      ...
      <div className="space-y-8 glass p-8 rounded-3xl">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>1. Introduction</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>2. Information We Collect</h2>

          <h3 className="text-lg font-semibold mt-6 mb-3" style={{ color: 'var(--ink)' }}>2.1 Information You Provide Directly</h3>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3" style={{ color: 'var(--ink)' }}>2.2 Information Collected Automatically</h3>
          <ul className="list-disc pl-5 space-y-2" style={{ color: 'var(--ink-90)' }}>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3" style={{ color: 'var(--ink)' }}>2.3 Information We Do Not Collect</h3>
          <ul className="list-disc pl-5 space-y-2" style={{ color: 'var(--ink-90)' }}>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>3. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>4. Data Storage and Security</h2>

          <h3 className="text-lg font-semibold mt-6 mb-3" style={{ color: 'var(--ink)' }}>4.1 Storage Infrastructure</h3>
          <ul className="list-disc pl-5 space-y-2" style={{ color: 'var(--ink-90)' }}>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3" style={{ color: 'var(--ink)' }}>4.2 Security Measures</h3>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>5. Third-Party Services</h2>
          <p className="leading-relaxed mb-4">
            We share information with the following third-party service providers, solely for the purposes of operating the Service:
          </p>
          <ul className="list-disc pl-5 space-y-2" style={{ color: 'var(--ink-90)' }}>
            <li><strong>Supabase:</strong> Authentication, database hosting, and real-time data synchronization. <a href="https://supabase.com/privacy" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
            <li><strong>Cloudflare:</strong> Backend infrastructure (Workers), media storage (R2), and content delivery. <a href="https://www.cloudflare.com/privacypolicy/" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
            <li><strong>PostHog:</strong> Product analytics and event tracking. Your user ID and email are shared for identification purposes. <a href="https://posthog.com/privacy" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
            <li><strong>RevenueCat:</strong> Subscription management and payment processing. Your user ID is shared to manage entitlements. <a href="https://www.revenuecat.com/privacy" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
            <li><strong>Apple (Apple Music API, Apple Sign-In):</strong> Song catalog data retrieval and authentication. <a href="https://www.apple.com/legal/privacy/" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
            <li><strong>Google (Google Sign-In):</strong> Authentication services. <a href="https://policies.google.com/privacy" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
            <li><strong>OpenStreetMap/Nominatim:</strong> Location search queries. Only your search text is transmitted; no personal identifiers are sent. <a href="https://wiki.osmfoundation.org/wiki/Privacy_Policy" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
            <li><strong>Expo (Push Notifications):</strong> Delivery of push notifications to your device. <a href="https://expo.dev/privacy" className="hover:underline" style={{ color: 'var(--accent)' }}>Privacy Policy</a></li>
          </ul>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>6. Data Sharing and Visibility</h2>
          <ul className="list-disc pl-5 space-y-2" style={{ color: 'var(--ink-90)' }}>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>7. Data Retention</h2>
          <p className="leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>8. Your Rights and Choices</h2>
          <p className="leading-relaxed mb-4">
          ...
          <p className="leading-relaxed mt-4">
            To exercise any of these rights, please contact us at <a href="mailto:support@musicmemory.app" className="hover:underline" style={{ color: 'var(--accent)' }}>support@musicmemory.app</a>.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>9. Children&apos;s Privacy</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>10. International Data Transfers</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>11. Changes to This Privacy Policy</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>12. Contact Us</h2>
          <p className="leading-relaxed">

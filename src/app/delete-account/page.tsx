  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24" style={{ color: 'var(--ink-90)' }}>
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4" style={{ color: 'var(--ink)' }}>Delete Account</h1>
        <p className="text-lg" style={{ color: 'var(--ink-90)' }}>
      ...
      <div className="space-y-8 glass p-8 rounded-3xl border border-red-500/20 relative overflow-hidden">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>How to request account deletion</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--ink)' }}>What happens when you delete your account?</h2>
